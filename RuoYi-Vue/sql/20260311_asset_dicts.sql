...
VALUES (1, '固定资产', '1', 'asset_type', '', 'success', 'Y', '0', 'admin', sysdate(), '', null, '');
INSERT INTO sys_dict_data (dict_sort, dict_label, dict_value, dict_type, css_class, list_class, is_default, status, create_by, create_time, update_by, update_time, remark)
VALUES (2, '不动产', '2', 'asset_type', '', 'primary', 'N', '0', 'admin', sysdate(), '', null, '');
...
INSERT INTO sys_dict_data (dict_sort, dict_label, dict_value, dict_type, css_class, list_class, is_default, status, create_by, create_time, update_by, update_time, remark)
VALUES (1, '在用', '1', 'asset_status', '', 'success', 'Y', '0', 'admin', sysdate(), '', null, '');
INSERT INTO sys_dict_data (dict_sort, dict_label, dict_value, dict_type, css_class, list_class, is_default, status, create_by, create_time, update_by, update_time, remark)
...
INSERT INTO sys_dict_data (dict_sort, dict_label, dict_value, dict_type, css_class, list_class, is_default, status, create_by, create_time, update_by, update_time, remark)
VALUES (6, '已处置', '6', 'asset_status', '', 'danger', 'N', '0', 'admin', sysdate(), '', null, '');
INSERT INTO sys_dict_data (dict_sort, dict_label, dict_value, dict_type, css_class, list_class, is_default, status, create_by, create_time, update_by, update_time, remark)
VALUES (7, '闲置', '7', 'asset_status', '', 'warning', 'N', '0', 'admin', sysdate(), '', null, '');
